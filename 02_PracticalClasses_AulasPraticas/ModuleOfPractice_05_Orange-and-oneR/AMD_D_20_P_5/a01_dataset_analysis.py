...
def test():
    ...
    # ---------------------
    # 3 f)
    # We can see that the error matrix is 1 - the conditional probability matrix
    # The error matrix is the frequency of values NOT IN the total,
    # while the conditional probability matrix is the frequency of values IN the total
    # The 1R uses the error matrix to find the best values to consider (have least error)
    # ---------------------
